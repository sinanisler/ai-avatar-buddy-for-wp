<?php
/**
 * GitHub Auto-Update for AI Avatar Buddy Plugin
 * 
...
$github_repo_name  = 'ai-avatar-buddy-for-wp';
$plugin_slug       = 'ai-avatar-buddy-for-wp';
$plugin_file       = 'ai-avatar-buddy-for-wp/ai-avatar-buddy.php';

/**
 * Check for Plugin Updates from GitHub
 */
add_filter('pre_set_site_transient_update_plugins', 'ai_avatar_buddy_check_github_update');
function ai_avatar_buddy_check_github_update($transient) {
 ...
 */
add_filter('plugins_api', 'ai_avatar_buddy_plugin_info_from_github', 10, 3);
function ai_avatar_buddy_plugin_info_from_github($result, $action, $args) {
    global $github_repo_owner, $github_repo_name, $plugin_slug, $plugin_file;
    ...
    $result = (object) array(
        ...
        'sections'      => array(
            'description' => $plugin_data['Description'] ?? __('An interactive AI-powered pixel art avatar buddy for your WordPress site.', 'snn'),
 ...
 */
add_action('admin_footer', 'ai_avatar_buddy_github_redirect_version_link');
function ai_avatar_buddy_github_redirect_version_link() {
    ...
    <script type="text/javascript">
        (function() {
            ...
            const pluginSlug = 'ai-avatar-buddy-for-wp';
            ...
            function processLinks() {
                ...
                const links = document.querySelectorAll('.plugin-title a, .update-message a, a[aria-label*="AI Avatar Buddy"]');
